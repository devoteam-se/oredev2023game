...
export const activateWordsAsNeeded = assign<GameplayContext, GameplayEvent>(
  (ctx: GameplayContext) => {
...
export const assignFocusedWord = assign<GameplayContext, GameplayEvent>(
  (ctx, event) => {
...
export const assignServerViewIndices = assign<GameplayContext, GameplayEvent>(
  (ctx) => {
...
export const assignWaveStartTime = assign<GameplayContext, GameplayEvent>(
  (ctx) => {
    const now = Date.now();
    return {
      wave: {
...
export const startHeatDisplayAnimation = assign<GameplayContext, GameplayEvent>(
  (ctx) => {
